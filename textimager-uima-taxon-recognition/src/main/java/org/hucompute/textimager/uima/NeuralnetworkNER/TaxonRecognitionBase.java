 ...
 * possible models.
 * <p>
 * See 'models' in taxon_recognition_rest.py in the python implementation for more details.
 *
 * @author Manuel Stoeckel
 */
public abstract class TaxonRecognitionBase extends DockerRestAnnotator {
    /**
     * The model name
     */
    ...
    @ConfigurationParameter(name = PARAM_MODEL_NAME, defaultValue = "conll2010-tuebadz") // FIXME: model name
    protected static String modelName;

    // Adds the "words" and "spaces" arrays for taxon-recognition to the JSON object
...
//			System.out.println(new JSONObject(res));
    ...
    protected String getDefaultDockerImage() {
        return "texttechnologylab/textimager-taxon-recognition:3";
    }
}
