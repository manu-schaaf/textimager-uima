 ...
 */
public class TaxonRecognition extends TaxonRecognitionBase {
    ...
    public void initialize(UimaContext aContext) throws ResourceInitializationException {
        ...
        namedEntityMappingProvider.setDefault(MappingProvider.LOCATION, "classpath:/org/hucompute/textimager/uima/TaxonRecognition/lib/ner-default.map");
