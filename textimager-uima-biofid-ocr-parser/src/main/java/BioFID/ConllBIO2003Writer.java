...
public class ConllBIO2003Writer extends Conll2003Writer {
	...
	@ConfigurationParameter(name = PARAM_NAMED_ENTITY_COLUMNS, mandatory = true, defaultValue = "1")
	private Integer pNamedEntityColumns;
	
	public static final String PARAM_CONLL_SEPARATOR = "pConllSeparator";
	@ConfigurationParameter(name = PARAM_CONLL_SEPARATOR, mandatory = true, defaultValue = " ")
	private String pConllSeparator;
	
	public static final String PARAM_CONLL_STRATEGY = "pEncoderStrategyIndex";
	@ConfigurationParameter(name = PARAM_CONLL_STRATEGY, mandatory = true, defaultValue = "0")
	private Integer pEncoderStrategyIndex;
	
	public static final String PARAM_FILTER_FINGERPRINTED = "pFilterFingerprinted";
	@ConfigurationParameter(name = PARAM_FILTER_FINGERPRINTED, mandatory = true, defaultValue = "false")
